...
public class PlaceCreditRequestHandler {
	...
	public PlaceCreditRequestHandler() {
		...
		factory.setAddress("http://localhost:8181/cxf/CustomerRelationsManagementService");
		...
		WebClient client = WebClient.create("http://localhost:8181/cxf/credit/",
				Collections.singletonList(provider));
		...
		factory.setAddress("http://localhost:8181/cxf/ContractManagementService");
